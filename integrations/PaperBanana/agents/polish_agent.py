...
class PolishAgent(BaseAgent):
    ...
    async def process(self, data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not gt_image_path_rel:
            print("[WARN] No GT image path found in data")
            return data
        ...
        if not gt_image_b64:
            print(f"[WARN] Failed to load GT image from {gt_image_path}")
            return data
        ...
        print(f"[INFO] [Step 1] Generating suggestions for {task_name}...")
        ...
        if not suggestions or "No changes needed" in suggestions:
            print("[INFO] No changes needed for this image.")
        ...
        print("[INFO] [Step 2] Polishing image with suggestions...")
        ...
        try:
            ...
            if response_list and response_list[0]:
                ...
                if converted_jpg:
                    ...
                    print("[WARN] Image conversion failed")
            else:
                print("[WARN] No response from model")
