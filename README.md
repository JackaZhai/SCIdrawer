...
## NOTE
目前作者只测试了deepseek+grsai和grsai+grsai的组合，其他组合由于没有API Key没有进行测试，可能会出现Bug！
由于作者的语言模型没有识图能力，所以无法使用评估和审图！！！这个选项当语言没有识图能力的时候不要打开！
Edit Banana实测效果未达到预期，正在寻找其他方案！
